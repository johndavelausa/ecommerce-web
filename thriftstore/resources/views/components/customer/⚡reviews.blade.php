                    ...
                    @foreach($pending as $row)
                        <li class="py-3 flex items-center justify-between gap-3">
                            ...
                            <button type="button"
                                    ...
                                    class="inline-flex items-center px-3 py-1.5 border border-[#2D9F4E] text-[#2D9F4E] rounded-md text-xs hover:bg-[#E8F5E9] transition-colors">
                                Write review
                            </button>
                        </li>
                    @endforeach
            ...
            @if($editingProductId)
                <form wire:submit.prevent="submit" class="space-y-3 text-sm">
                    ...
                    <div class="flex gap-2 pt-1">
                        <button type="submit"
                                class="inline-flex items-center px-4 py-2 bg-[#2D9F4E] border border-[#2D9F4E] rounded-md text-xs font-semibold text-white uppercase tracking-widest shadow-sm hover:bg-[#1B7A37] focus:outline-none focus:ring-2 focus:ring-[#2D9F4E] focus:ring-offset-2 transition-colors">
                            Submit review
                        </button>
