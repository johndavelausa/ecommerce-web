...
<aside x-data="{ sidebarOpen: false }"
    ...
    <nav class="admin-sidebar-nav">
        ...
        @if((string) \App\Models\SystemSetting::get('maintenance_mode', '0') === '1')
            <div class="mt-4 px-3">
                <div class="bg-rose-500/20 border border-rose-500/40 rounded-xl p-3 text-center">
                    <div class="text-[10px] font-bold text-rose-400 uppercase tracking-widest mb-1">Maintenance Active</div>
                    <p class="text-[10px] text-rose-200/70 leading-relaxed italic">The site is currently hidden from customers & sellers.</p>
                </div>
            </div>
        @endif
    </nav>
