            ...
            <div style="width:100%;padding-bottom:32px;">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:12px;align-items:center;margin-bottom:20px;">
                    ...
                    <div style="margin-left:auto;display:flex;gap:8px;">
                        <a href="{{ route('admin.reports.export-all', ['sales_period' => $salesPeriod ?? 'monthly', 'refund_dispute_filter' => $refundDisputeFilter ?? 'all']) }}" class="rep-export-btn">📥 Export all (CSV)</a>
                        <a href="{{ route('admin.reports.payments.export') }}" class="rep-export-btn">📥 Export payments (CSV)</a>
                    </div>
                </div>
